...
int   RSSdata[20]={7,6,6,5,5,5,4,4,4,4,3,3,3,3,3,3,3,2,2,2};
//---------------------------------------------------------------------------------//
...
void aproxFFT_func(int in[],int N,float *fft_amps){ 
  ...
  // by removing the mean from the data, the intensity of all frequencies besides the DC component will be the same
  // this is okay since that component is not important for our application
...
{
int temp3,m1,m2;
int temp1,temp2, test,quad,accuracy;
