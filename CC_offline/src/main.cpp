...
PeakHandler FFT_peak=PeakHandler(SAMPLE_FREQ, PEAK_N,SAMPLES, peak_value, peak_amps, FFT_amp, signal_abcissa);
...
void loop() {
  ...
  if(sample_n==SAMPLES-1){
    ...
    sample_n=0;
    if(kmeans_state>=0 && samples_sent[kmeans_state]<100){
